...
//-------Caxa de Dialogo de Paredes
//-----------------------------------------------------------------------------------
UPSLPar : dialog {				//dialog name
          label = "UP'SLayerCAD v2 - Paredes" ;//give it a label
//-------inicio da ---1---------------
:row{
  : boxed_column {
      key = "br0" ;
...
//-------------------------------------------------------------------------------------
//-------Caxa de Dialogo de PAVIMENTO
//-------------------------------------------------------------------------------------
UPSLPav : dialog {				//dialog name
          label = "UP'SLayerCAD v2 - Pavimento" ;//give it a label
//-------inicio da ---1---------------
:row{
  : boxed_column {
      key = "br0" ;
